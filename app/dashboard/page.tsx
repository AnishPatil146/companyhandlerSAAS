...
import {
  ...
  Plus, User as UserIcon, Loader2, Trash2 // 🔥 Trash2 Icon Add Kiya
} from 'lucide-react';
import {
...
// 🔥 FIREBASE IMPORTS (Delete & Update add kiya) 🔥
...
export default function MasterDashboard() {
  ...
  if (isAuthChecking) {
    return (
      <div className="flex h-screen items-center justify-center bg-[#0a0a0a] text-zinc-400 font-sans text-sm">
      ...
      <aside className="w-64 border-r border-zinc-800/60 bg-[#0a0a0a] flex flex-col justify-between">
        ...
        <div className="p-4 border-t border-zinc-800/60">
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-zinc-500 hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors"
          >
                  ...
                  <table className="w-full text-left text-sm">
                    ...
                    <tbody>
                      {isLoadingData ? (
                        ...
                        leads.map(l => (
                          <tr key={l.id} className="border-b border-zinc-800/30 hover:bg-[#161616] transition-colors group">
                            ...
                            <td className="p-4">
                              <select
                                ...
                                className={`bg-zinc-800/50 text-zinc-300 px-2 py-1.5 rounded text-xs font-medium border border-zinc-700/50 outline-none cursor-pointer hover:bg-zinc-700 transition-colors
                                  ${l.status === 'Won' ? 'text-emerald-400 border-emerald-500/30 bg-emerald-500/10' : ''}
                                  ${l.status === 'Lost' ? 'text-red-400 border-red-500/30 bg-red-500/10' : ''}
                                `}
                              >
                                ...
                                <option value="Won" className="bg-zinc-900 text-emerald-400">Won</option>
                                <option value="Lost" className="bg-zinc-900 text-red-400">Lost</option>
                              </select>
                            </td>
